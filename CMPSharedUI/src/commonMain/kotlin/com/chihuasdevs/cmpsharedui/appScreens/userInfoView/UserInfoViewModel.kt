package com.chihuasdevs.cmpsharedui.appScreens.userInfoView
...
class UserInfoViewModel(private val userInfoUIEventsDelegate: UserInfoUIEventsDelegate? = null) : BusinessUserInfoDelegate {
    ...
    fun validateEmailFormat(email: String) {
        ...
        isEmailValid = email.matches(emailRegex.toRegex())
    }
